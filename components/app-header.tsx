      ...
      <div className="mx-auto flex min-h-[68px] w-full max-w-[calc(var(--app-content-max-width)-2rem)] items-center justify-between gap-4 rounded-[20px] border border-gray-200 bg-transparent px-4 py-2.5 shadow-sm saturate-145 backdrop-blur-xl lg:max-w-[calc(var(--app-content-max-width)-2.5rem)] dark:border-white/8 dark:bg-[linear-gradient(180deg,rgba(13,20,33,0.78),rgba(8,13,24,0.68))] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_18px_42px_rgba(2,6,23,0.2)]">
        ...
        <div className="flex min-w-0 items-center gap-2.5 lg:gap-3">
          <div className="flex min-w-0 flex-col justify-center py-0.5">
            <span className="border-gray-200bg-transparent inline-flex h-5 w-fit items-center self-start rounded-full border px-2 text-[10px] tracking-[0.14em] text-[#b1bfd0] uppercase dark:border-white/6 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.025))] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
              Plaza
            </span>
            <div className="mt-1 flex min-w-0 items-center gap-2.5">
              <h1
                title="广场"
                className="truncate text-[22px] leading-none font-semibold tracking-tight text-gray-600 dark:text-[#eef4ff]"
              >
                广场
              </h1>
              <p
                title="先找方向，再进入真正的生产闭环"
                className="max-w-[20ch] truncate text-[11px] leading-[1.35] text-[#91a0b5]"
              >
                方向确认后生产
              </p>
            </div>
