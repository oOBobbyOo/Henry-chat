 ...
 */
export const DEFAULT_MODEL_CONFIG: Omit<Chat.ModelConfig, 'id'> = {
 ...
 */
export const INITIAL_PRIMARY_MODEL: Chat.ModelConfig = {
  id: 'primary-model',
 ...
 * @returns 完整的模型配置
 */
export function createModelConfig(overrides?: Partial<Chat.ModelConfig>): Chat.ModelConfig {
  modelIdCounter += 1
